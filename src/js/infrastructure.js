// Infrastructure Page Specific JavaScript
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const ctaButtons = document.querySelectorAll('.bg-blue-600.hover\\:bg-blue-800');
    ...
    function updateAuthUI() {
        const buttons = [authButton, authButtonMobile];
        buttons.forEach(button => {
            if (button) {
                if (isLoggedIn) {
                    button.innerHTML = '<i class="fas fa-sign-out-alt"></i><span>Logout</span>';
                    button.classList.remove('bg-white', 'text-ucla-blue', 'border-2', 'border-ucla-blue');
                    button.classList.add('bg-red-500', 'text-white');
                } else {
                    button.innerHTML = '<i class="fas fa-sign-in-alt"></i><span>Login</span>';
                    button.classList.remove('bg-red-500', 'text-white');
                    button.classList.add('bg-white', 'text-ucla-blue', 'border-2', 'border-ucla-blue');
                }
            }
        });
    }
    ...
    if (authButtonMobile && !isLoggedIn) {
    ...
    console.log('Infrastructure page JavaScript loaded successfully!');
}); 